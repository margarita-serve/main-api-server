...
type CreateModelPackageRequestDTO struct {
	...
	ModelFrameWork        string  `json:"modelFrameWork" example:"SkLearn" validate:"required" extensions:"x-order=08" enums:"TensorFlow, PyTorch, SkLearn, XGBoost, LightGBM"` // 모델 프레임워크
	ModelFrameWorkVersion string  `json:"modelFrameWorkVersion" example:"1.1.0" extensions:"x-order=09"`                                                                        // 모델 프레임워크 버전

...
func (e DeploymentCreated) AccuracyAnalyze() bool {
	return e.accuracyAnalyze
}
...
func NewEventDeploymentCreated(deploymentID string, modelPackageID string, featureDriftTracking bool, accuracyAnalyze bool, associationID string, associationIDInFeature bool, modelHistoryID string) DeploymentCreated {
	return DeploymentCreated{deploymentID: deploymentID,
		modelPackageID:         modelPackageID,
		featureDriftTracking:   featureDriftTracking,
		accuracyAnalyze:        accuracyAnalyze,
...
func (e DeploymentUpdated) Name() string {
	return "event.deployment.updated"
}

func (e DeploymentUpdated) DeploymentID() string {
	return e.deploymentID
}

func (e DeploymentUpdated) ModelPackageID() string {
	return e.modelPackageID
}

func (e DeploymentUpdated) FeatureDriftTracking() *bool {
	return e.featureDriftTracking
}

func (e DeploymentUpdated) AccuracyAnalyze() *bool {
	return e.accuracyAnalyze
}

func (e DeploymentUpdated) AssociationID() *string {
	return e.associationID
}

func (e DeploymentUpdated) AssociationIDInFeature() *bool {
	return e.associationIDInFeature
}

func (e DeploymentUpdated) ModelHistoryID() string {
	return e.modelHistoryID
}

func NewEventDeploymentUpdated(deploymentID string, modelPackageID string, featureDriftTracking *bool, accuracyAnalyze *bool, associationID *string, associationIDInFeature *bool, modelHistoryID string) DeploymentUpdated {
	return DeploymentUpdated{deploymentID: deploymentID,
		modelPackageID:         modelPackageID,
		featureDriftTracking:   featureDriftTracking,
		accuracyAnalyze:        accuracyAnalyze,
		associationID:          associationID,
...
func NewEventDeploymentInActived(deploymentID string) DeploymentActived {
	return DeploymentActived{deploymentID: deploymentID}
}

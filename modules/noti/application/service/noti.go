...
func NewNotiService(h *handler.Handler, EmailSvc IEmailService) (*NotiService, error) {
	// var err error
...
// Create
func (s *NotiService) Create(req *appDTO.CreatePredictionEnvRequestDTO, i identity.Identity) (*appDTO.CreatePredictionEnvResponseDTO, error) {
	// //authorization
...
func (s *NotiService) Delete(req *appDTO.DeletePredictionEnvRequestDTO, i identity.Identity) (*appDTO.DeletePredictionEnvResponseDTO, error) {
	// //authorization
	// if i.CanAccessCurrentRequest() == false {
	// 	errMsg := fmt.Sprintf("You are not authorized to access [`%s.%s`]",
	// 		i.RequestInfo.RequestObject, i.RequestInfo.RequestAction)
...
func (s *NotiService) UpdatePredictionEnv(req *appDTO.UpdatePredictionEnvRequestDTO, i identity.Identity) (*appDTO.UpdatePredictionEnvResponseDTO, error) {
	// //authorization
	// if i.CanAccessCurrentRequest() == false {
	// 	errMsg := fmt.Sprintf("You are not authorized to access [`%s.%s`]",
	// 		i.RequestInfo.RequestObject, i.RequestInfo.RequestAction)
...
func (s *NotiService) GetByID(req *appDTO.GetPredictionEnvRequestDTO, i identity.Identity) (*appDTO.GetPredictionEnvResponseDTO, error) {
	// //authorization
	// if i.CanAccessCurrentRequest() == false {
	// 	errMsg := fmt.Sprintf("You are not authorized to access [`%s.%s`]",
	// 		i.RequestInfo.RequestObject, i.RequestInfo.RequestAction)
...
func (s *NotiService) GetList(req *appDTO.GetPredictionEnvListRequestDTO, i identity.Identity) (*appDTO.GetPredictionEnvListResponseDTO, error) {
	// //authorization
	// if i.CanAccessCurrentRequest() == false {
	// 	errMsg := fmt.Sprintf("You are not authorized to access [`%s.%s`]",
	// 		i.RequestInfo.RequestObject, i.RequestInfo.RequestAction)
...
func (s *NotiService) GetListByProject(req *appDTO.GetProjectsPredictionEnvsRequestDTO, i identity.Identity) (*appDTO.GetProjectsPredictionEnvsResponseDTO, error) {
	// //authorization
	// if i.CanAccessCurrentRequest() == false {
	// 	errMsg := fmt.Sprintf("You are not authorized to access [`%s.%s`]",
	// 		i.RequestInfo.RequestObject, i.RequestInfo.RequestAction)
...
func (s *NotiService) getClusterInfoByID(ClusterInfoID string, i identity.Identity) (*appDTO.InternalGetClusterInfoResponseDTO, error) {
...
func (s *NotiService) GetByIDInternal(req *appDTO.InternalGetPredictionEnvRequestDTO, i identity.Identity) (*appDTO.InternalGetPredictionEnvResponseDTO, error) {
	// //authorization
	// if i.CanAccessCurrentRequest() == false {
	// 	errMsg := fmt.Sprintf("You are not authorized to access [`%s.%s`]",
	// 		i.RequestInfo.RequestObject, i.RequestInfo.RequestAction)

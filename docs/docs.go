    ...
    "definitions": {
        ...
        "dto.GetDeploymentResponseDTO": {
            ...
            "properties": {
                ...
                "serviceHealthStatus": {
                    "description": "서비스 상태, 24시간 기준 요청이 없을경우 = unknown, 4xx \u003e=1 인경우 = warning, 5xx \u003e=1 인경우 = failing, 4xx or 5xx 없을경우 = pass",
                    "type": "string",
                    "x-order": "16",
                    "example": "pass"
                },
                "driftStatus": {
                    "description": "데이터 드리프트 상태, 사용자가 지정한 드리프트 모니터 셋팅에 따라 결정 /30초간격, unknown, warning, failing,  정상 = pass",
                    "type": "string",
                    "x-order": "17",
                    "example": "pass"
                },
                "accuracyStatus": {
                    "description": "모델 정확도 상태, 사용자가 지정한 정확도 모니터 셋팅에 따라 결정 /30초간격, unknown, warning, failing,  정상 = pass",
                    "type": "string",
                    "x-order": "18",
                    "example": "pass"
                },
